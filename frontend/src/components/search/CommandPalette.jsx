                ...
                <div className="py-2">
                  ...
                  {results.map((item, idx) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 rounded-xl flex items-center justify-between group transition-all ${idx === selectedIndex ? 'bg-primary/10 border border-primary/20' : 'border border-transparent hover:bg-slate-800/40'
                        }`}
                    >
                      <div className="flex items-center gap-4">
                        <div className={`p-2 rounded-lg ${item.label === 'Employee' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-indigo-500/10 text-indigo-400'
                          }`}>
